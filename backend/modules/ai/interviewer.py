...
- После создания профиля нужно добавить фото (до 5 штук) — кнопка появится ниже
- После фото — пройти анкету совместимости (15 вопросов)
- Алгоритм подберёт совместимых людей и предложит до 5 вариантов в день
- Пользователь может написать или отклонить предложенного человека
- Если оба написали — открывается чат на 48 часов

Отвечай 1-3 предложениями, не более.
"""
